...
export type finish_reason = "stop" | "tool_calls" | "length" | "content_filter" | null
export type usage = {
...
export type message = message_system | message_user | message_assistant | message_tool
...
export type chat_completion_chunk = chat_completion_chunk_success | chat_completion_chunk_error
